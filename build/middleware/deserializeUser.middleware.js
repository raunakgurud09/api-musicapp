...
var deserializeUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, refreshToken, _a, decoded, expired;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                accessToken = (0, lodash_1.get)(req, 'headers.authorization', '').replace(/^Bearer\s/, '');
                refreshToken = (0, lodash_1.get)(req, 'headers.cookie');
                if (!accessToken)
                    return [2 /*return*/, next()];
                return [4 /*yield*/, (0, jwt_utils_1.decode)(accessToken)];
            case 1:
                _a = _b.sent(), decoded = _a.decoded, expired = _a.expired;
                if (decoded) {
